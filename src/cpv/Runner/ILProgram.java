...
{
    private Vector ProgramText;            // vector<String>

////////////////////////////////////////////////////////////////////////////////
    public ILProgram(Vector text)          // make a program object from textual representation
    {
        ProgramText = text;
    }
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public void Save(PrintWriter enc) throws java.io.IOException
    {
        ...
        for(int i = 0; i < ProgramText.size(); i++)
            enc.println((String)ProgramText.get(i));
    }
////////////////////////////////////////////////////////////////////////////////
    public String GetLine(int index)             // get line chunk before description (syntax of the line: "code//descripttion")
    {
...
////////////////////////////////////////////////////////////////////////////////
    private String HTMLRep(String s)    // replace "<" by &lt
    {                                   // replace ">" by &gt
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public Vector GetProcessVariables(String procname) throws RuntimeErrorException
    {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public Vector GetCommonVariables() throws RuntimeErrorException
    {
        int beg_idx = 0;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    private Vector GetVariables(int BeginLine, int EndLine) throws RuntimeErrorException
    {
