...
//------------------------------------------------------------------------
    protected Shape createShape()                              // create an arrow
    {
        ...
        Point2D DestPoint = ((PortView)view.getTarget()).getLocation(null);
        MyVertexView DestView = (MyVertexView)view.getTarget().getParentView();
        ...
        else if (label.equals("single"))  // in case of a single edge make it straight
        {
        ...
        else                      // curved arrow
        {
            ...
            P1 = DestView.getPerimeterPoint(null, new Point((int)DestPoint.getX(), (int)DestPoint.getY()), PM);
        }
